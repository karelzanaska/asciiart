...
class ImportingAndExportingRGBImageTestsTdl3 extends FunSuite {
  ...
  test("TDL=3; path: 1 - 3 - 9 - 15 - 17") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/randomImage.bmp")
  ...
  test("TDL=3; path: 1 - 3 - 10 - 16 - 17") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output-gradient.bmp")
  ...
  test("TDL=3; path: 1 - 2 - 5 - 21 - 18") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output2.jpg")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.png", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 2 - 6 - 22 - 18") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output2.png")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.jpg", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 2 - 7 - 23 - 18") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output2.gif")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.gif", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 2 - 8 - 24 - 18") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output2.bmp")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.bmp", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 3 - 9 - 15 - 18") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output-random.jpg")
    val args = List("--image-random", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 3 - 10 - 16 - 18") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output-gradient.jpg")
    val args = List("--image-random-gradient", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 2 - 5 - 21 - 19") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output3.jpg")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.png", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 2 - 6 - 22 - 19") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output3.png")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.jpg", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 2 - 7 - 23 - 19") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output3.gif")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.gif", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 2 - 8 - 24 - 19") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output3.bmp")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.bmp", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 3 - 9 - 15 - 19") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output-random.png")
    val args = List("--image-random", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 3 - 10 - 16 - 19") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output-gradient.png")
    val args = List("--image-random-gradient", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 2 - 5 - 21 - 20") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output4.jpg")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.png", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 2 - 6 - 22 - 20") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output4.png")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.jpg", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 2 - 7 - 23 - 20") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output4.gif")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.gif", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 2 - 8 - 24 - 20") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output4.bmp")
    val args = List("--image", "/home/karel/FEL/ZKS/asciiart/samples/cloud.bmp", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 3 - 9 - 15 - 20") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output-random2.jpg")
    val args = List("--image-random", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
  ...
  test("TDL=3; path: 1 - 3 - 10 - 16 - 20") {
    val controller = new ConsoleController()
    val outputPath = Paths.get("/home/karel/FEL/ZKS/asciiart/samples/artifacts/output-gradient2.jpg")
    val args = List("--image-random-gradient", "--output-rgb-file", outputPath.toString)
    val consoleView = new ConsoleView(controller, args)
    consoleView.run()
